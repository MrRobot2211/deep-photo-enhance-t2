...
FLAGS['load_model_path']     =  'checkpoints/LPGAN_exp_G3_736/' + '%s.ckpt'     % (FLAGS['format_log_step'] % FLAGS['num_epoch'])
FLAGS['load_model_path_new'] =   'checkpoints/LPGAN_exp_G3_736/' + '%s-new.ckpt' % (FLAGS['format_log_step'] % FLAGS['num_epoch'])
FLAGS['data_output_ext'] = '.jpg'
