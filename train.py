...
def parse_args():
    ...
    parser.add_argument('--model_dir', type=str, default=FLAGS['path_result'] + FLAGS['path_char'] + 'model' + FLAGS['path_char'])
...
if __name__ == '__main__': 
    ...
    netG_train_outputs , netG_test_outputs , netG_train_output_for_netD_list , netG_train_output_inv_list ,netG_test_output_inv_list = get_netG_outputs(netG,train_df,test_df, FLAGS)
    ...
    netD_train_outputs,netD_test_outputs,netD_netG_train_outputs, gradient_penalties = get_D_G_outputs(netD,netG,netG_train_outputs,netG_train_output_for_netD_list,netG_test_outputs,gp_weight_1,gp_weight_2,FLAGS)
    ...
    netG_total_loss, netD_total_loss, netG_loss , netD_loss,netG_train_loss,netD_train_loss ,netD_test_loss,netG_test_loss, netG_batch_list_train_loss, netG_train_list,netD_train_list,netG_test_list,train_data_terms, train_constant_term_list,test_data_terms, test_constant_term_list, netG_crops,  netG_train_output_inv_crop_list, netG_test_output_inv_crop_list = get_losses(netG_train_outputs , netG_test_outputs, train_df, test_df , netG_train_output_inv_list ,netG_test_output_inv_list,netD_netG_train_outputs,netD_train_outputs,netD_test_outputs,gradient_penalties,netG_w_regularization_loss,netD_w_regularization_loss)
    ...
    netG_train_1_1 ,netG_train_2_1,netG_train_1_2 ,netG_train_2_2 = netG_train_list
    netD_train_1_1 ,netD_train_2_1,netD_train_1_2 ,netD_train_2_2 = netD_train_list
    netG_test_1_1 ,netG_test_2_1,netG_test_1_2 ,netG_test_2_2 = netG_test_list
    ...
    netG_train_output1_inv_crop, netG_train_output2_inv_crop = netG_train_output_inv_crop_list
    netG_test_output1_inv_crop, netG_test_output2_inv_crop = netG_test_output_inv_crop_list
